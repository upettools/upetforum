...
$settings['bbname'] = "Upettools Fish Community Forums";
$settings['bburl'] = "http://fish.upettools.com";
...
$settings['ckeditor_theme'] = "moonocolor";
...
$settings['cpstyle'] = "";
$settings['cookiedomain'] = ".fish.upettools.com";
$settings['cookiepath'] = "/";
...
$settings['ckeditor_disablelocation'] = "";
$settings['hiddencaptchaimage'] = "0";
$settings['failedlogintext'] = "1";
$settings['ckeditor_ajaxbbcodeparser'] = "1";
$settings['ckeditor_height'] = "250";
$settings['ckeditor_editormode'] = "wysiwyg";
...
$settings['homename'] = "Upettools Fish Community";
$settings['homeurl'] = "http://fish.upettools.com/";
$settings['latestposts_threadcount'] = "15";
$settings['ckeditor_autosave'] = "25";
...
$settings['ckeditor_maxheight'] = "450";
...
$settings['ckeditor_minilocation'] = "showthread.php";
...
$settings['smtp_host'] = "hwsmtp.exmail.qq.com";
$settings['smtp_pass'] = "elevenSUN123";
$settings['smtp_port'] = "465";
$settings['smtp_user'] = "info@upettools.com";
$settings['statscachetime'] = "0";
$settings['statslimit'] = "15";
$settings['purgespammerapikey'] = "";
$settings['subforumsindex'] = "2";
$settings['ckeditor_color'] = "#cecece";
...
$settings['ckeditor_active'] = "1";
$settings['uploadspath'] = "./uploads";
$settings['cdnurl'] = "";
$settings['ckeditor_usedivarea'] = "0";
