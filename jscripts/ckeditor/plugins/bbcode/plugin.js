...
return true;}}},1);editor.dataProcessor.writer=writer;function onSetData(evt){var bbcode=evt.data.dataValue;if(CKEDITOR.ajaxbbcodeparser!='1')
{bbcode=BBCODEparser_custom_first(bbcode);}
bbcode=bbcodeParser.bbcodeToHtml(bbcode);bbcode=bbcode.replace(/\n/g,'<br>');if(CKEDITOR.ajaxbbcodeparser!='1')
