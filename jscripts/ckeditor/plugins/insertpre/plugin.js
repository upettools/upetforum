...
{return{title:editor.lang.insertpre.title,minWidth:540,minHeight:380,contents:[{id:'general',label:editor.lang.insertpre.code,elements:[{type:'textarea',id:'contents',label:editor.lang.insertpre.code,cols:140,rows:22,dir:'ltr','class':'code_textarea',validate:CKEDITOR.dialog.validate.notEmpty(editor.lang.insertpre.notEmpty),required:true,setup:function(element)
